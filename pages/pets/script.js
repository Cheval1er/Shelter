...
function numbering(windowWidth = window.innerWidth) {
  let itemsPerPage = 0;
  ...
  let slides = Array.from(document.querySelectorAll(".friends-item"));
  let slidesQuantity = document.querySelectorAll(".friends-item").length;
  let pagesQuantity = Math.ceil(slidesQuantity / itemsPerPage);
  let pageNumber = 1;

  let buttonsParent = document.querySelector(".numbering");
  ...
  function paginate(e) {
    ...
    let previousPageBtnPressed = Array.from(e.target.classList).includes("numbering-arrow-left");

    let nextPageBtnPressed = Array.from(e.target.classList).includes("numbering-arrow-right");
    
    let toFirstPageBtnPressed = Array.from(e.target.classList).includes("numbering-twin-arrow-left");

    let toLastPageBtnPressed = Array.from(e.target.classList).includes("numbering-twin-arrow-right");
  ...
  function showSlides() {
    ...
    let pageElement = document.querySelector(".numbering-page");
  ...
  function reset() {
    ...
    document.querySelector(".numbering-twin-arrow-left").classList.remove("numbering-disabled");
    document.querySelector(".numbering-twin-arrow-right").classList.remove("numbering-disabled");
    document.querySelector(".numbering-arrow-left").classList.remove("numbering-disabled");
    document.querySelector(".numbering-arrow-right").classList.remove("numbering-disabled");
  }
  ...
  function adjustButtonStyles() {
    if (pageNumber === 1) {
      document.querySelector(".numbering-twin-arrow-left").classList.add("numbering-disabled");
      document.querySelector(".numbering-arrow-left").classList.add("numbering-disabled");
    }

    if (pageNumber === pagesQuantity) {
      document.querySelector(".numbering-twin-arrow-right").classList.add("numbering-disabled");
      document.querySelector(".numbering-arrow-right").classList.add("numbering-disabled");
    }
  }
